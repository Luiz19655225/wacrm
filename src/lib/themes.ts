...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: "wavon",
    name: "Wavon",
    tagline: "O padrão da marca — índigo premium, de azul a violeta.",
    swatch: "oklch(0.58 0.23 280)",
  },
  {
    id: "violet",
    name: "Violeta",
    tagline: "O padrão — confiante, um toque divertido.",
  ...
  },
  {
    id: "cobalt",
    name: "Cobalto",
    tagline: "Azul B2B SaaS — calmo e com cara de produto.",
    swatch: "oklch(0.585 0.2 254)",
  },
  {
    id: "amber",
    name: "Âmbar",
    tagline: "Caloroso e amigável — combina com times de PMEs.",
    swatch: "oklch(0.745 0.16 65)",
  },
  {
    id: "rose",
    name: "Rosa",
    tagline: "Marcante e moderno — D2C, creator economy, lifestyle.",
