      ...
      <header className="flex items-center justify-between gap-3 border-b border-border px-5 py-4">
        <div>
          ...
          <p className="mt-0.5 text-xs text-muted-foreground">
            Minutos até responder a primeira mensagem não respondida de um
      ...
      <div className="p-5">
        {loading || !data ? (
          ...
          <EmptyState
            ...
            hint="Este gráfico se preenche conforme você responde mensagens de clientes."
          />
        ) : (
          <BarChart
            data={chartData}
