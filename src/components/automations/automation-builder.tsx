...
const STEP_META: Record<AutomationStepType, StepMeta> = {
  ...
  create_deal: { label: "Criar negociação", icon: Briefcase, border: "border-l-primary" },
...
const TRIGGER_OPTIONS: { value: AutomationTriggerType; label: string; hint: string }[] = [
  { value: "new_message_received", label: "Nova mensagem recebida", hint: "Qualquer mensagem recebida" },
  {
    ...
    hint: "A primeira vez que este contato te envia uma mensagem (também funciona para contatos adicionados manualmente)",
  },
      ...
      <div className="rounded-lg border border-border border-l-4 border-l-blue-500 bg-card shadow-lg">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <div className="text-[11px] uppercase tracking-wide text-blue-300">Disparo</div>
