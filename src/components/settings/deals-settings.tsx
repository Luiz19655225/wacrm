...
export function DealsSettings() {
  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Negociações e moeda"
        description="A moeda usada para novas negociações e para os totais do funil e do painel."
      />
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Novas negociações usam esta moeda por padrão, e os totais do
            funil e do painel são exibidos nela. Negociações existentes
            mantêm a moeda com a qual foram salvas.
          </CardDescription>
        </CardHeader>
