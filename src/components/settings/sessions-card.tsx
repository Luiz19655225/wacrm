  ...
  return (
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Desconecte de todos os dispositivos em que você está logado —
            incluindo este. Útil se você perdeu um notebook ou compartilhou sua senha.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Desconectar de todos os dispositivos?</DialogTitle>
            <DialogDescription>
