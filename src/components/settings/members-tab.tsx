...
const EDITABLE_ROLES: { value: AccountRole; label: string; hint: string }[] = [
  ...
  { value: 'agent', label: 'Agente', hint: 'Usa funcionalidades; sem acesso a configurações' },
        ...
        <div>
          ...
          {invitations.length > 0 ? (
            <p className="mb-3 text-xs text-muted-foreground">
              A URL de convite em texto puro só é exibida uma vez na
              criação por segurança — para compartilhar de novo, revogue
        ...
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              ...
              da conta? A pessoa será desconectada desta conta e receberá uma
              conta pessoal nova no próximo login. O login dela não é excluído.
            </DialogDescription>
          </DialogHeader>
