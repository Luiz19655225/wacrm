...
const ROLE_DESCRIPTIONS: Record<InviteRole, string> = {
  ...
  agent:
    'Pode usar o inbox, contatos, disparos, automações e fluxos. Sem acesso a configurações ou membros.',
...
export function InviteMemberDialog({
  ...
  async function handleCreate() {
    ...
    try {
      ...
      setResult({
        ...
        accountName: account?.name ?? 'nossa conta WAVON',
      });
      onCreated();
    } catch (err) {
  ...
  function whatsappShareUrl(url: string): string {
    ...
    const accountName = result?.accountName ?? 'nossa conta WAVON';
    const message = `Entre em ${accountName} no WAVON usando este link (válido por ${result?.expiresInDays} dias): ${url}`;
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Compartilhe este link com seu novo colega. Ele(a) poderá se
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md border border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
                ...
                Nunca armazenamos o texto puro — ao fechar este diálogo a URL
                desaparece. Para compartilhar de novo, revogue este convite e
                crie um novo.
              </div>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                Slack ou qualquer canal — sem precisar de serviço de e-mail.
              </DialogDescription>
            </DialogHeader>
